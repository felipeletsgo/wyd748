...
// Entry: 00583217 | Name: FUN_00583217


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

ulonglong *
FUN_00583217(ulonglong *param_1,undefined4 param_2,undefined8 *param_3,undefined4 *param_4,
...

{
  ...
  FUN_00582fc0(param_1,param_2,puVar1);
  if (param_3 != (undefined8 *)0x0) {
    FastExitMediaState();
    uVar4 = param_3[2];
    uVar5 = PackedIntToFloatingDwordConv(*param_3,*param_3);
    uVar6 = PackedIntToFloatingDwordConv(param_3[1],param_3[1]);
    uVar2 = PackedFloatingADD(*param_1 ^ DAT_005a8720,_DAT_005a8728);
    uVar6 = PackedFloatingMUL(uVar6,DAT_005a8730);
