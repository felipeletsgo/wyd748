...
// Entry: 00522d56 | Name: FUN_00522d56


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_00522d56(int param_1,int param_2)

{
  ...
  local_8 = 0xffffffff;
  puStack_c = &LAB_005a217e;
  local_10 = ExceptionList;
  if (*(int *)(param_1 + 0x214) == 0) {
    ExceptionList = &local_10;
    if ((*(int *)(param_1 + 0x740) != 10) &&
       (ExceptionList = &local_10, local_14 = FUN_004f9a46(), *(int *)(param_1 + 0x740) != 0xb)) {
    ...
    if (*(int *)(DAT_0067cf38 + 0x4c) == param_1) {
      ...
      if (iVar1 == 30000) {
        ...
        if ((*(int *)(local_34 + 0x27ac0) != 0) && (*(int *)(param_1 + 0x438) != 0)) {
          ...
          FUN_0058f078(local_d8,&DAT_005bb7e4,local_b8);
      ...
      iVar1 = FUN_00494dcf();
      if ((iVar1 == 30000) && (local_2c = local_28, *(int *)(local_28 + 0x27aac) != 0)) {
        (**(code **)(**(int **)(local_28 + 0x27aac) + 0x80))(param_1 + 0x168,1);
      }
    }
  }
  ExceptionList = local_10;
