...
// Entry: 005808ea | Name: FUN_005808ea


void FUN_005808ea(undefined8 *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  PackedFloatingMUL(DAT_005a8730,param_3);
  PackedFloatingMUL(DAT_005a8730,param_2);
  uVar2 = FUN_0058af60();
  uVar3 = FUN_0058af60();
  uVar4 = FUN_0058af60();
  ...
  uVar3 = PackedFloatingMUL(CONCAT44(uVar1,uVar1) ^ DAT_005a86c0,uVar10);
  uVar5 = PackedFloatingMUL(CONCAT44(uVar1,uVar1),uVar4);
  uVar7 = PackedFloatingMUL(CONCAT44(uVar9,uVar9),uVar4);
  uVar10 = PackedFloatingMUL(CONCAT44(uVar9,uVar9) ^ DAT_005a86c0 >> 0x20,uVar10);
  ...
  uVar6 = PackedFloatingSUBR(uVar5,CONCAT44(DAT_005a86a4,DAT_005a86a0));
  uVar7 = PackedFloatingSUBR(uVar10,CONCAT44(DAT_005a86a4,DAT_005a86a0));
