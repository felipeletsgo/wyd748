...
// Entry: 0049c80b | Name: FUN_0049c80b


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

float10 __thiscall FUN_0049c80b(int param_1,float param_2,float param_3)

{
  ...
  if (*(int *)(param_1 + 0x40) != 0) {
    if ((((*(float *)(*(int *)(param_1 + 0x40) + 0x20a28) <= param_2) &&
      ...
      fVar1 = (float10)FUN_005399cb(param_2,param_3);
      return fVar1;
    }
