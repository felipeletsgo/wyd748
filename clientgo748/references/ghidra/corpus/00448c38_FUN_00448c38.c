...
// Entry: 00448c38 | Name: FUN_00448c38


void __fastcall FUN_00448c38(int param_1)

{
  ...
  *(undefined2 *)(DAT_013b71e8 + 0xdaa) = *(undefined2 *)(*(int *)(param_1 + 0x4c) + 0x20);
  *(undefined2 *)(DAT_013b71e8 + 0xda8) = 0x3ba;
  for (local_10 = 0; local_10 < 8; local_10 = local_10 + 1) {
    *(undefined1 *)(DAT_013b71e8 + local_10 + 0xdf0) = 0xff;
  }
  for (local_10 = 0; local_10 < 6; local_10 = local_10 + 1) {
    local_1c = (undefined4 *)0x0;
    if (*(int *)(param_1 + 0x27bb8 + local_10 * 4) != 0) {
      local_1c = (undefined4 *)
                 (**(code **)(**(int **)(param_1 + 0x27bb8 + local_10 * 4) + 0xa4))(0,0);
    }
