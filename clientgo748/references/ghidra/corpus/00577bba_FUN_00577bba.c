...
// Entry: 00577bba | Name: FUN_00577bba


float * FUN_00577bba(float *param_1,float *param_2)

{
  ...
  if (fVar1 == 0.0) {
    ...
    *param_1 = 0.0;
    ...
    fVar3 = ((float)((uint)fVar1 & 0xffffff | 0x3f000000) * *(float *)(&DAT_005c6da0 + uVar4) +
            *(float *)(&DAT_005c6da4 + uVar4)) * (float)(0xbeffffffU - (int)fVar1 >> 1 & 0xff800000)
    ;
    fVar1 = param_2[1];
    fVar2 = param_2[2];
