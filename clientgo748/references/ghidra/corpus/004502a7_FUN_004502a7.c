...
// Entry: 004502a7 | Name: FUN_004502a7


void __fastcall FUN_004502a7(int param_1)

{
  ...
  for (local_10 = 8; -1 < local_10; local_10 = local_10 + -1) {
    for (local_14 = 6; -1 < local_14; local_14 = local_14 + -1) {
      ...
      if ((local_18 != 0) &&
         (iVar2 = FUN_0044ff33(CONCAT22((short)((uint)*(undefined2 **)(local_18 + 0x670) >> 0x10),
                                        *(undefined2 *)(DAT_013b71e8 + 0x7b8)),
                               CONCAT22(extraout_var,**(undefined2 **)(local_18 + 0x670))),
         iVar2 != 0)) {
        local_c = 1;
        break;
      }
    ...
    if (local_1c == 0xf) {
      ...
      *(int *)(param_1 + 0x27478) = local_20;
      ...
      if (iVar2 < 2) {
        ...
        iVar1 = local_18;
        FUN_0058f078(local_18 + 0x39a,&PTR_DAT_005b7d70,iVar2 + -1);
