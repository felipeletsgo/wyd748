...
// Entry: 00424337 | Name: FUN_00424337


SOCKET __thiscall
FUN_00424337(SOCKET *param_1,char *param_2,undefined4 param_3,undefined4 param_4,u_int param_5)
  ...
  if (local_8 == 0xffffffff) {
    ...
    if (iVar2 == -1) {
      ...
      if (iVar2 == -1) {
        ...
        iVar2 = bind(local_8,&local_18,0x10);
        if (iVar2 == -1) {
          MessageBoxA((HWND)0x0,s_Binding_fail_005b1ffc,s_ERROR_005b1ff4,0);
          closesocket(local_8);
          return 0;
        }
      }
    }
    FUN_0058f078(local_128,s_sock__d_ip__d__d__d__d_port__d___005b200c,local_8,local_18.sa_data[2],
    ...
    if (iVar2 < 0) {
      FUN_0058f078(local_128,s_sock__d_ip__d__d__d__d_port__d___005b2030,local_8,local_28.sa_data[2]
      ...
      *param_1 = 0;
      ...
      FUN_0058f078(local_128,s_sock__d_ip__d__d__d__d_port__d___005b2054,local_8,local_28.sa_data[2]
                   ,local_28.sa_data[3],local_28.sa_data[4],local_28.sa_data[5],
                   local_28.sa_data._0_2_,param_3);
