...
// Entry: 0056c136 | Name: FUN_0056c136


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_0056c136(int param_1,uint param_2,uint param_3,int param_4)

{
  ...
  if (*(int *)(param_1 + 0x1058) != 0) {
    ...
    do {
      ...
      iVar3 = iVar6 + 8;
      iVar6 = iVar6 + 0x10;
      *puVar7 = (ushort)(((int)ROUND(*pfVar1 * _DAT_005a6974 + fVar4) << 5 |
                         (int)ROUND(*(float *)(iVar2 + param_4) * _DAT_005a6974 + fVar4)) << 5) |
