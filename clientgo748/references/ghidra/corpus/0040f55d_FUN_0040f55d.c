...
// Entry: 0040f55d | Name: FUN_0040f55d


int __thiscall FUN_0040f55d(int param_1,undefined4 param_2,undefined4 param_3)
...
LAB_0040f5d1:
    ...
    if ((local_10 != 0) && (iVar1 = FUN_0040df5a(param_2,param_3), iVar1 == 1)) {
      local_14 = local_c;
      goto LAB_0040f5d1;
    }
    local_c = local_c + 1;
