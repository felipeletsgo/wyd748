...
// Entry: 00597f4a | Name: FUN_00597f4a


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00597f4a(void)
  ...
  if (cVar1 != '\0') {
    ...
    if (uVar2 == 0) {
      *(undefined4 *)(unaff_EBP + -0x8e) = 4;
      in_ST0 = (float10)fscale(in_ST0,(float10)_DAT_005aa228);
      if (ABS(in_ST0) < (float10)_DAT_005aa218) {
        in_ST0 = in_ST0 * (float10)_DAT_005aa238;
      }
      goto LAB_00598019;
    }
    if (uVar2 == 0x7ff0) {
      *(undefined4 *)(unaff_EBP + -0x8e) = 3;
      in_ST0 = (float10)fscale(in_ST0,(float10)_DAT_005aa220);
      if ((float10)_DAT_005aa210 < ABS(in_ST0)) {
        in_ST0 = in_ST0 * (float10)_DAT_005aa230;
      }
      goto LAB_00598019;
    }
  }
...
LAB_00598019:
  ...
  *(double *)(unaff_EBP + -0x76) = (double)in_ST0;
  FUN_0059aff6((int)*(char *)(*(int *)(unaff_EBP + -0x94) + 0xe),unaff_EBP + -0x8e,unaff_EBP + -0xa4
              );
  return;
}
