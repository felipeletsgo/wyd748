...
// Entry: 0059a7d3 | Name: FUN_0059a7d3


undefined4 FUN_0059a7d3(int param_1,int param_2)

{
  ...
  if (((*puVar1 & 1 << (bVar3 & 0x1f)) != 0) &&
     (iVar2 = FUN_0059a734(param_1,param_2 + 1), iVar2 == 0)) {
    local_8 = FUN_0059a77d(param_1,param_2 + -1);
  }
