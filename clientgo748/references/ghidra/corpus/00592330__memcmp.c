...
LAB_005923aa:
        ...
        if (uVar2 != 1) {
          ...
          bVar4 = (byte)(uVar1 >> 8);
          bVar9 = bVar6 < bVar4;
          if (bVar6 != bVar4) goto LAB_005923aa;
          iVar3 = 0;
          if (uVar2 != 2) {
            bVar9 = (uVar5 & 0xff0000) < (uVar1 & 0xff0000);
            if ((uVar5 & 0xff0000) != (uVar1 & 0xff0000)) goto LAB_005923aa;
            iVar3 = uVar2 - 3;
          }
        }
        return iVar3;
      ...
      if ((_Size & 1) == 0) goto LAB_0059235d;
      bVar9 = *(byte *)_Buf1 < *(byte *)_Buf2;
      if (*(byte *)_Buf1 != *(byte *)_Buf2) goto LAB_005923aa;
...
LAB_0059235d:
        ...
        if ((*(byte *)_Buf1 != *(byte *)_Buf2) ||
           ...
           *(byte *)((int)_Buf1 + 1) != *(byte *)((int)_Buf2 + 1))) goto LAB_005923aa;
