...
// Entry: 004484f3 | Name: FUN_004484f3


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_004484f3(int param_1,int param_2)

{
  ...
  DAT_005b12bc = 0xffff;
  iVar5 = *(int *)(param_1 + 0x285f0);
  iVar6 = *(int *)(param_1 + 0x27b38);
  piVar1 = *(int **)(param_1 + 0x285d4);
  piVar2 = *(int **)(param_1 + 0x27b34);
  piVar3 = *(int **)(param_1 + 0x27c7c);
  piVar4 = *(int **)(param_1 + 0x27bdc);
  if (DAT_005b892c == 2) {
    (**(code **)(**(int **)(param_1 + 0x285d8) + 0x60))(param_2);
    if (param_2 != 0) {
      (**(code **)(*piVar2 + 0x70))
