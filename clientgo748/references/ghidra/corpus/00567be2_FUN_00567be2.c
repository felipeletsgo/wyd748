...
// Entry: 00567be2 | Name: FUN_00567be2


undefined4
FUN_00567be2(undefined8 *param_1,undefined8 *param_2,uint param_3,int param_4,int param_5,
            int param_6)

{
  ...
  uVar12 = FUN_005679a3(param_1,param_2,param_3,param_4,param_5,param_6);
  return uVar12;
}
