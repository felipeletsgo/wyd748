...
// Entry: 0040eafc | Name: FUN_0040eafc


undefined4 FUN_0040eafc(undefined4 param_1,int param_2,int param_3,int param_4)

{
  ...
  if ((7 < local_90) || (local_90 < 0)) {
    local_90 = 0;
  }
  FUN_0058f220(local_98,&DAT_005bec4c + local_90 * 8,8);
  _memset(local_84,0,0x7e);
  for (local_8c = 0; local_8c < 0x7e; local_8c = local_8c + 1) {
