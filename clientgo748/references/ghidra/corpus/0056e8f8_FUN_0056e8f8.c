...
// Entry: 0056e8f8 | Name: FUN_0056e8f8


/* WARNING: Removing unreachable block (ram,0x0056e992) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_0056e8f8(int param_1,int param_2,int param_3,float *param_4)

{
  ...
  for (; puVar4 < puVar1; puVar4 = puVar4 + 1) {
    ...
    *param_4 = (float)(int)((short)((short)*puVar4 << 6) >> 6) * fVar3;
    ...
    param_4[3] = (float)(*puVar4 >> 0x1e) * _DAT_005a69ac;
    param_4 = param_4 + 4;
  }
