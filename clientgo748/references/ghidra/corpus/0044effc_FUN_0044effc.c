...
// Entry: 0044effc | Name: FUN_0044effc


void __fastcall FUN_0044effc(int param_1)

{
  ...
  for (local_10 = 8; -1 < local_10; local_10 = local_10 + -1) {
    for (local_14 = 6; -1 < local_14; local_14 = local_14 + -1) {
      ...
      if ((local_18 != 0) &&
         ((((((**(short **)(local_18 + 0x670) == 0x1001 || (**(short **)(local_18 + 0x670) == 0xd67)
              ) || (**(short **)(local_18 + 0x670) == 0xcfa)) ||
            ((399 < **(short **)(local_18 + 0x670) && (**(short **)(local_18 + 0x670) < 0x195)))) ||
           ((**(short **)(local_18 + 0x670) == 0x19f ||
            ((0x1ab < **(short **)(local_18 + 0x670) && (**(short **)(local_18 + 0x670) < 0x1b0)))))
           ) || ((0x2a7 < **(short **)(local_18 + 0x670) && (**(short **)(local_18 + 0x670) < 0x2ae)
                 ))))) {
        local_c = 1;
        break;
      }
  ...
  if ((local_c == 1) && (local_18 != 0)) {
    ...
    if (local_1c == 1) {
      ...
      if ((*(int *)(param_1 + 0x27478) != 0) &&
         ((uint)(local_20 - *(int *)(param_1 + 0x27478)) < 200)) {
        return;
      }
      (**(code **)(*local_8 + 0xc0))
      ...
      *(int *)(param_1 + 0x27478) = local_20;
      ...
      if (iVar2 < 2) {
        ...
        iVar1 = local_18;
        FUN_0058f078(local_18 + 0x39a,&PTR_DAT_005b7d64,iVar2 + -1);
