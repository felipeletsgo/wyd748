...
// Entry: 0057a06e | Name: FUN_0057a06e


void FUN_0057a06e(undefined4 param_1,int param_2,byte *param_3,byte *param_4,int param_5)

{
  ...
  if (param_5 != 0) {
    if (param_5 == 1) {
      ...
      FUN_005733ef(param_1,"Ignoring bad adaptive filter type");
      *param_3 = 0;
    }
  }
  return;
