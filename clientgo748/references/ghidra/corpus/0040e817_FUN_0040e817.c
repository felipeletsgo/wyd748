...
// Entry: 0040e817 | Name: FUN_0040e817


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 __thiscall FUN_0040e817(int param_1,int *param_2,int param_3,int param_4)

{
  ...
  for (local_8 = 0; local_8 < param_2[0x77]; local_8 = local_8 + 1) {
    for (local_10 = 0; local_10 < param_2[0x76]; local_10 = local_10 + 1) {
      if ((param_3 + local_10 < *(int *)(param_1 + 0x1ec)) &&
         (param_4 + local_8 < *(int *)(param_1 + 0x1e8))) {
        *(undefined4 *)
         (*(int *)(param_1 + 0x1f0) +
         ((param_4 + local_8) * *(int *)(param_1 + 0x1ec) + param_3 + local_10) * 4) = 1;
      }
    }
  }
