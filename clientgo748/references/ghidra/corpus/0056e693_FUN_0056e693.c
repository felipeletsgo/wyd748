...
// Entry: 0056e693 | Name: FUN_0056e693


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_0056e693(int param_1,int param_2,int param_3,float *param_4)

{
  ...
  for (; pcVar3 < pcVar1; pcVar3 = pcVar3 + 4) {
    *param_4 = (float)(int)*pcVar3 * fVar2;
    ...
    param_4[2] = 0.0;
    param_4[3] = (float)(byte)pcVar3[2] * _DAT_005a68b0;
    param_4 = param_4 + 4;
  }
