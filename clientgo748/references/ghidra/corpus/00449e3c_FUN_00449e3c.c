...
// Entry: 00449e3c | Name: FUN_00449e3c


void __thiscall FUN_00449e3c(int param_1,int param_2)
    ...
    if (DAT_005b892c == 2) {
      if (param_2 == 1) {
        if ((*(int *)(param_1 + 0x27b34) != 0) &&
           (*(int *)(*(int *)(param_1 + 0x27b34) + 0x28) == 0)) {
          FUN_00447691();
        }
        (**(code **)(**(int **)(param_1 + 0x27c10) + 0x60))(1);
        *(undefined4 *)(DAT_005ccf9c + 0x2a5e4) = 0;
        (**(code **)(*DAT_005ccec0 + 0x98))();
        *(undefined4 *)(*(int *)(param_1 + 0x2873c) + 0x400) = 0x15;
        FUN_00447f6f(0);
      }
      else {
        if ((*(int *)(param_1 + 0x27b34) != 0) &&
