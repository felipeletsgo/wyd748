...
// Entry: 00449384 | Name: FUN_00449384


void __thiscall FUN_00449384(int param_1,int param_2)

{
  ...
  if (DAT_005b892c == 2) {
    if (param_2 == 1) {
      ...
      (**(code **)(**(int **)(param_1 + 0x27b6c) + 0x60))(1);
      *(undefined4 *)(DAT_005ccf9c + 0x2a5e4) = 0;
      (**(code **)(*DAT_005ccec0 + 0x98))();
      *(undefined4 *)(*(int *)(param_1 + 0x2873c) + 0x400) = 0xd;
      FUN_00447f6f(0);
    }
    else {
