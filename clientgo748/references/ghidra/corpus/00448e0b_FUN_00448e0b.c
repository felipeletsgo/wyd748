...
// Entry: 00448e0b | Name: FUN_00448e0b


void __fastcall FUN_00448e0b(int param_1)

{
  ...
  *(undefined2 *)(DAT_013b71e8 + 0xdfe) = *(undefined2 *)(*(int *)(param_1 + 0x4c) + 0x20);
  *(undefined2 *)(DAT_013b71e8 + 0xdfc) = 0x3c0;
  for (local_10 = 0; local_10 < 8; local_10 = local_10 + 1) {
    *(undefined1 *)(DAT_013b71e8 + local_10 + 0xe44) = 0xff;
  }
  for (local_10 = 0; local_10 < 3; local_10 = local_10 + 1) {
    local_1c = (undefined4 *)0x0;
    if (*(int *)(param_1 + 0x27bec + local_10 * 4) != 0) {
      local_1c = (undefined4 *)
                 (**(code **)(**(int **)(param_1 + 0x27bec + local_10 * 4) + 0xa4))(0,0);
    }
