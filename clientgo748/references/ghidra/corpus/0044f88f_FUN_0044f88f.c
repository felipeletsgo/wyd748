...
// Entry: 0044f88f | Name: FUN_0044f88f


void __fastcall FUN_0044f88f(int param_1)

{
  ...
  for (local_10 = 8; -1 < local_10; local_10 = local_10 + -1) {
    for (local_14 = 6; -1 < local_14; local_14 = local_14 + -1) {
      ...
      if ((((local_18 != 0) && (*(int *)(local_18 + 0x670) != 0)) &&
          (local_1c = FUN_0054cd07(*(undefined4 *)(local_18 + 0x670),0x26), local_1c == 0xe6)) &&
         (**(short **)(local_18 + 0x670) != 0xd32)) {
        local_c = 1;
        break;
      }
    }
  ...
  if ((local_c == 1) && (local_18 != 0)) {
    local_20 = FUN_0054cd07(*(undefined4 *)(local_18 + 0x670),0x26);
    if (local_20 == 0xe6) {
      local_24 = (**(code **)(*DAT_0092e654 + 8))();
      if ((*(int *)(param_1 + 0x27478) != 0) &&
         ((uint)(local_24 - *(int *)(param_1 + 0x27478)) < 200)) {
        return;
      }
      (**(code **)(*local_8 + 0xc0))
                (*(undefined4 *)(*(int *)(local_18 + 0x1e4) + 0x1e4),
                 *(undefined4 *)(*(int *)(local_18 + 0x1e4) + 0x400));
      local_54 = (**(code **)(*local_8 + 0xc4))(*(undefined4 *)(*(int *)(local_18 + 0x1e4) + 0x1e4))
      ;
      if (local_54 == -1) {
        local_54 = (short)*(undefined4 *)(local_18 + 0x1d0) +
                   (short)*(undefined4 *)(local_18 + 0x1d4) * 9;
      }
      _memset(local_48,0,0x24);
      local_42 = *(undefined2 *)(DAT_013b71e8 + 0xc5c);
      local_44 = 0x373;
      local_3c = 1;
      ...
      local_2c = __ftol();
      local_2a = __ftol();
      FUN_0055f2dd(local_48,0x24);
      *(int *)(param_1 + 0x27478) = local_24;
      ...
      if (iVar2 < 2) {
        ...
        iVar1 = local_18;
        FUN_0058f078(local_18 + 0x39a,&PTR_DAT_005b7d6c,iVar2 + -1);
