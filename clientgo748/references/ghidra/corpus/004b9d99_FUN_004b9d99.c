...
// Entry: 004b9d99 | Name: FUN_004b9d99


undefined4 __thiscall FUN_004b9d99(int param_1,int param_2)

{
  ...
  if (*(int *)(*(int *)(param_1 + 0xe8334) + param_2 * 4) == 0) {
    ...
    for (local_20 = 0; local_20 < 0xff; local_20 = local_20 + 1) {
      if ((*(char *)(param_1 + 0xc7328 + local_20 + param_2 * 0x108) == '.') &&
         (iVar1 = _strcmp((char *)(param_1 + 0xc7328 + local_20 + param_2 * 0x108),&DAT_005ba9cc),
         iVar1 == 0)) {
        local_24 = 1;
        break;
      }
    ...
    local_14 = (void *)0x0;
    local_2c = FUN_0058fb07(param_1 + 0xc7328 + param_2 * 0x108,0x8000,0);
    if (local_2c == -1) {
      uVar2 = 0;
    }
    else {
      ...
      if (local_24 == 0) {
        ...
        if (*(char *)(param_1 + 0xc7427 + param_2 * 0x108) == 'A') {
        ...
        else if (*(char *)(param_1 + 0xc7427 + param_2 * 0x108) == 'a') {
          if ((*(int *)(DAT_005ccf9c + 0x2a390) == 1) || (*(int *)(DAT_005ccf9c + 0x2a510) == 0x10))
          {
            local_28 = 0x19;
          }
        ...
        if (*(char *)((int)local_14 + 0x54) == '2') {
          FUN_0058f078(local_38,&DAT_005ba9d4);
          FUN_0058f220((int)local_14 + 0x54,local_38,4);
        }
        else {
          FUN_0058f078(local_38,&DAT_005ba9dc);
          FUN_0058f220((int)local_14 + 0x54,local_38,4);
        }
        FUN_0058f75f(local_2c);
        if (((*(int *)(DAT_005ccf9c + 0x2a5c0) == 1) && (*(int *)(DAT_005ccf9c + 0x2a5c4) == 1)) &&
          ...
          local_28 = *(undefined4 *)(DAT_005ccf9c + 0x2a514);
          if ((*(char *)(param_1 + 0xc7427 + param_2 * 0x108) == 'A') ||
             (*(char *)(param_1 + 0xc7427 + param_2 * 0x108) == 'C')) {
          ...
          if (*(char *)(param_1 + 0xc7427 + param_2 * 0x108) == 'N') {
            if ((*(int *)(DAT_005ccf9c + 0x2a390) == 1) ||
               (*(int *)(DAT_005ccf9c + 0x2a510) == 0x10)) {
              local_28 = 0x18;
            }
      ...
      local_18 = (uint)(0x13 < DAT_005b4920);
      if (local_18 == 0) {
        iVar1 = FUN_00560eab(*(undefined4 *)(DAT_005ccf9c + 0x2a3e4),local_14,local_10 + local_30,
                             ...
                             *(int *)(param_1 + 0xe8334) + param_2 * 4);
        if (iVar1 < 0) {
          *(undefined4 *)(*(int *)(param_1 + 0xe8334) + param_2 * 4) = 0;
