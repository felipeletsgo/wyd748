...
// Entry: 00448fde | Name: FUN_00448fde


void __fastcall FUN_00448fde(int param_1)

{
  ...
  *(undefined2 *)(DAT_013b71e8 + 0xe52) = *(undefined2 *)(*(int *)(param_1 + 0x4c) + 0x20);
  *(undefined2 *)(DAT_013b71e8 + 0xe50) = 0x2c3;
  for (local_10 = 0; local_10 < 8; local_10 = local_10 + 1) {
    *(undefined1 *)(DAT_013b71e8 + local_10 + 0xe98) = 0xff;
  }
  for (local_10 = 0; local_10 < 7; local_10 = local_10 + 1) {
    local_1c = (undefined4 *)0x0;
    if (*(int *)(param_1 + 0x27c14 + local_10 * 4) != 0) {
      local_1c = (undefined4 *)
                 (**(code **)(**(int **)(param_1 + 0x27c14 + local_10 * 4) + 0xa4))(0,0);
    }
