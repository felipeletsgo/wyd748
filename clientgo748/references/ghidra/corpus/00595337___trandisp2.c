...
// Entry: 00595337 | Name: __trandisp2
...

{
  ...
  *(ushort *)(unaff_EBP + -0xa0) =
  ...
  cVar2 = (char)(*(char *)(unaff_EBP + -0x9f) << 1) >> 1;
                    /* WARNING: Could not recover jumptable at 0x005953c1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(param_2 + (char)((&DAT_005c9f1c)[(byte)(cVar2 << 1 | cVar2 < '\0') & 0xf] |
                               (&DAT_005c9f1c)[(byte)((bVar3 & 7) << 1 | (char)bVar3 < '\0')] << 2)
              + 0x10))();
  return;
}
