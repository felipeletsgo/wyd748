...
// Entry: 00561644 | Name: FUN_00561644


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_00561644(float *param_1,float *param_2,float *param_3,float *param_4,float *param_5,
                 float param_6)

{
  ...
  fVar2 = param_6 * fVar1;
  fVar3 = ((fVar2 + fVar2) - _DAT_005a6800 * fVar1) + _DAT_005a67d8;
  param_6 = (fVar2 - (fVar1 + fVar1)) + param_6;
  fVar4 = _DAT_005a6800 * fVar1 - (fVar2 + fVar2);
  fVar2 = fVar2 - fVar1;
