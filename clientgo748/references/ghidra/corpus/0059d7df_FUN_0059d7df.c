...
// Entry: 0059d7df | Name: FUN_0059d7df


int FUN_0059d7df(LCID param_1,DWORD param_2,byte *param_3,int param_4,byte *param_5,int param_6,
                UINT param_7)

{
  ...
  local_1c = puVar1;
  if (0 < param_4) {
    param_4 = FUN_0059b506(param_3,param_4);
  }
  if (0 < param_6) {
    param_6 = FUN_0059b506(param_5,param_6);
  }
  if (DAT_013b8378 == 2) {
