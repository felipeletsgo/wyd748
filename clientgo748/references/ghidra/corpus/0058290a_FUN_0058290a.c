...
// Entry: 0058290a | Name: FUN_0058290a


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined8 * FUN_0058290a(undefined8 *param_1,undefined4 *param_2,undefined8 *param_3)

{
  ...
  uVar9 = PackedFloatingMUL(CONCAT44((int)uVar9,(int)uVar13),_DAT_005a8690);
  uStack_34 = (undefined4)((ulonglong)uVar19 >> 0x20);
  uVar13 = CONCAT44(uStack_34,(int)((ulonglong)uVar10 >> 0x20));
  uVar15 = PackedFloatingMUL(CONCAT44(*(undefined4 *)(param_3 + 2),(int)*param_3),_DAT_005a8690);
  ...
  uVar13 = PackedFloatingMUL(uVar9,_DAT_005a8690);
