...
// Entry: 004306ce | Name: FUN_004306ce


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall
FUN_004306ce(int *param_1,float param_2,float param_3,float param_4,float param_5,float param_6,
...

{
  ...
  local_10 = 256.0;
  if (param_10 != (int *)0x0) {
    (**(code **)(*param_10 + 0x38))(param_10,0,local_34);
    local_8 = (float)local_1c;
    local_10 = (float)local_18;
  }
  local_c = param_14 * _DAT_005a34a0;
  param_1[0xa9c5] = (int)(param_6 - param_8 * local_c);
  param_1[0xa9c6] = (int)(param_7 - param_9 * local_c);
  param_1[0xa9cc] = (int)(param_8 * local_c + param_6);
  param_1[0xa9cd] = (int)(param_7 - param_9 * local_c);
  param_1[0xa9d3] = (int)(param_8 * local_c + param_6);
  param_1[0xa9d4] = (int)(param_9 * local_c + param_7);
  param_1[0xa9da] = (int)(param_6 - param_8 * local_c);
  param_1[0xa9db] = (int)(param_9 * local_c + param_7);
  if ((_DAT_005a4214 < param_13) || (param_13 < _DAT_005a4210)) {
    param_1[0xa9df] = (int)(param_2 / local_8);
    param_1[0xa9e0] = (int)((param_5 / _DAT_005a365c + param_3) / local_10);
    param_1[0xa9ca] = (int)((param_4 / _DAT_005a365c + param_2) / local_8);
    param_1[0xa9cb] = (int)(param_3 / local_10);
    param_1[0xa9d1] = (int)((param_2 + param_4) / local_8);
    param_1[0xa9d2] = (int)((param_5 / _DAT_005a365c + param_3) / local_10);
    param_1[0xa9d8] = (int)((param_4 / _DAT_005a365c + param_2) / local_8);
    param_1[0xa9d9] = (int)((param_3 + param_5) / local_10);
  }
  else {
    param_1[0xa9ca] = (int)(param_2 / local_8);
    param_1[0xa9cb] = (int)(param_3 / local_10);
    param_1[0xa9d1] = (int)((param_2 + param_4) / local_8);
    param_1[0xa9d2] = (int)(param_3 / local_10);
    param_1[0xa9d8] = (int)((param_2 + param_4) / local_8);
    param_1[0xa9d9] = (int)((param_3 + param_5) / local_10);
    param_1[0xa9df] = (int)(param_2 / local_8);
    param_1[0xa9e0] = (int)((param_3 + param_5) / local_10);
  }
  for (local_14 = 0; local_14 < 4; local_14 = local_14 + 1) {
    param_1[local_14 * 7 + 0xa9c9] = param_11;
  }
