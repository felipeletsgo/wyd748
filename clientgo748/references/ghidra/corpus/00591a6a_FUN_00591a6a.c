...
// Entry: 00591a6a | Name: FUN_00591a6a


int FUN_00591a6a(int param_1,int param_2,int param_3)

{
  ...
  if (((*(uint *)(param_1 + 0xc) & 0x83) == 0) ||
    ...
    *(uint *)(param_1 + 0xc) = *(uint *)(param_1 + 0xc) & 0xffffffef;
    if (param_3 == 1) {
      iVar2 = FUN_005918dd(param_1);
      param_2 = param_2 + iVar2;
      param_3 = 0;
    }
    FUN_00591cb4(param_1);
    ...
    iVar2 = FUN_005950cc(*(undefined4 *)(param_1 + 0x10),param_2,param_3);
    iVar2 = (iVar2 != -1) - 1;
  }
  return iVar2;
}
