...
`CLIENT_TESTED` exige execução do fluxo no executável correspondente à
implementação registrada; build ou startup isolado não bastam. Um teste antigo
do TMProject não valida automaticamente o client Go.
