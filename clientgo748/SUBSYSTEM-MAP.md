...
| Render e assets | WYT `CLIENT_TESTED`; MSH `CONTRACT`, layouts/skinning `AUTOMATED_TESTED`; BON/ANI parser, hierarquia e playback básico `AUTOMATED_TESTED` | ligar câmera/material/textura, integrar personagem animado e portar a transição especial entre clips; validar no client antes de `CLIENT_TESTED` |
