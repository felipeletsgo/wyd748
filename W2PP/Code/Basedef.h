...
// Range completo de mobs da Carta (N, M e A) para o Wave System
#define CARTA_N_MOB_RANGE_START				2391
#define CARTA_N_MOB_RANGE_END				2419

#pragma endregion

#pragma region CARTA N WAVE SYSTEM
#define MAX_CARTA_N_INSTANCES	3

// Coordenadas de cada instância (área de detecção do jogador e mobs)
// Áreas separadas para evitar conflito entre instâncias
// Instância 1 - centro (808, 3666), área de detecção
#define CARTA_N_INSTANCE1_X1	780
#define CARTA_N_INSTANCE1_Y1	3655
#define CARTA_N_INSTANCE1_X2	835
#define CARTA_N_INSTANCE1_Y2	3700

// Instância 2 - centro (862, 3677), área de detecção (SEPARADA)
#define CARTA_N_INSTANCE2_X1	840
#define CARTA_N_INSTANCE2_Y1	3655
#define CARTA_N_INSTANCE2_X2	885
#define CARTA_N_INSTANCE2_Y2	3700

// Instância 3 - centro (862, 3622), área de detecção (SEPARADA)
#define CARTA_N_INSTANCE3_X1	840
#define CARTA_N_INSTANCE3_Y1	3600
#define CARTA_N_INSTANCE3_X2	885
#define CARTA_N_INSTANCE3_Y2	3645
#pragma endregion

#pragma region CARTA N MOB ORGANIZADO POR INSTANCIA
// Instância 1 - FreneticoA (5051), DementeA (5052), NecromanteA (5053), SafadaA (5054)
#define CARTA_N_I1_WAVE1_MOB		5051	// FreneticoA
#define CARTA_N_I1_WAVE2_MOB		5052	// DementeA
#define CARTA_N_I1_WAVE3_MOB		5053	// NecromanteA
#define CARTA_N_I1_BOSS			5054	// SafadaA (Boss)

// Instância 2 - FreneticoB (5055), DementeB (5056), NecromanteB (5057), SafadaB (5058)
#define CARTA_N_I2_WAVE1_MOB		5055	// FreneticoB
#define CARTA_N_I2_WAVE2_MOB		5056	// DementeB
#define CARTA_N_I2_WAVE3_MOB		5057	// NecromanteB
#define CARTA_N_I2_BOSS			5058	// SafadaB (Boss)

// Instância 3 - FreneticoC (5059), DementeC (5060), NecromanteC (5061), SafadaC (5062)
#define CARTA_N_I3_WAVE1_MOB		5059	// FreneticoC
#define CARTA_N_I3_WAVE2_MOB		5060	// DementeC
#define CARTA_N_I3_WAVE3_MOB		5061	// NecromanteC
#define CARTA_N_I3_BOSS			5062	// SafadaC (Boss)

// Range completo de mobs da Carta Wave System
#define CARTA_N_WAVE_MOB_START		5051
#define CARTA_N_WAVE_MOB_END		5062
#pragma endregion
