...
extern  "C"  __declspec(dllexport) void __cdecl DigDon_V1()  // Função API (init) da dll
{
	...
	carrega.IP_Server_and_Hard = "26.224.236.28";   //This IP Need be like: "192.168.1.1" or "adress.sytes.net" without [www, http:// or [port], This IP are used by: FTP Up/Down and server Ban post autenticatition
