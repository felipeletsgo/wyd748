...
#pragma region Trajes	
	...
	if (item->sIndex == 5774)
	{
		sprintf_s(line1, 128, "Clique com botão direito para desequipar o item");
		*line1Color = Azul;
		sprintf_s(line2, 128, "Jogue em cima do item para equipa-lo");
		*line2Color = Azul;
		sprintf_s(line3, 128, "Utilizavel apenas em Cintos");
		*line3Color = Laranja;
		return 10;
	}
	if (item->sIndex == 5775)
	{
		...
		*line1Color = Azul;
		sprintf_s(line2, 128, "Jogue em cima do item para equipa-lo");
		*line2Color = Azul;
		sprintf_s(line3, 128, "Utilizavel apenas em Colar");
		*line3Color = Laranja;
		return 10;
	}
	if (item->sIndex == 5614)
