...
bool HookNaked::Start()
{
	try
	{
		...
		WYD.SetValue(0x043b2f5 + 1, WYD.GetPtr("https://wydbrasil.com.br/img_guilds/"));/*Altera endereço das img das guildas*/
		WYD.SetValue(0x043b111 + 1, WYD.GetPtr("https://wydbrasil.com.br/img_guilds/"));/*Altera endereço das img das guildas*/
