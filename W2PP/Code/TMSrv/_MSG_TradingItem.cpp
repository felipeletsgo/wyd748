...
void Exec_MSG_TradingItem(int conn, char *pMsg)
{
	...
	if ((m->DestPlace == ITEM_PLACE_CARGO || m->SrcPlace == ITEM_PLACE_CARGO) && pUser[conn].Ingame.Lojinha == 1) {
		SendClientMessage(conn, "Não pode movimentar itens no bau com a loja aberta");
		return;
	}
		...
		if (DestItem->sIndex != 3505 && SrcItem->sIndex != 3505 && DestItem->sIndex != 4144 && SrcItem->sIndex != 4144 && DestItem->sIndex != 3980 || m->DestPlace != ITEM_PLACE_CARRY && m->SrcPlace != ITEM_PLACE_CARRY)
		{
			...
			if (Can && YouCan)
			{
				...
				if ((save1.sIndex == save2.sIndex && save1.sIndex == 413
					...
					|| save1.sIndex == save2.sIndex && save1.sIndex == 5813
					|| save1.sIndex == save2.sIndex && save1.sIndex == 5811
					|| save1.sIndex == save2.sIndex && save1.sIndex == 5812
					|| save1.sIndex == save2.sIndex && save1.sIndex == 5814
					|| save1.sIndex == save2.sIndex && save1.sIndex == 5815
					|| save1.sIndex == save2.sIndex && save1.sIndex == 5816
					|| save1.sIndex == save2.sIndex && save1.sIndex == 5817
					...
					|| save1.sIndex == save2.sIndex && save1.sIndex >= 5752 && save1.sIndex <= 6500
				...
				if (save1.sIndex == 3915 && save1.stEffect[0].cEffect == 0 && save1.stEffect[1].cEffect == 0 && save1.stEffect[2].cEffect == 0)
				{
					BASE_FadaDate(&save1, 6); // fadas 7 dias
					SendItem(conn, m->SrcPlace, m->SrcSlot, &save1);
				}
