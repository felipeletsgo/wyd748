...
void Exec_MSG_SplitItem(int conn, char* pMsg)
{
	...
	if (pMob[conn].MOB.Carry[slot].sIndex != 412 && pMob[conn].MOB.Carry[slot].sIndex != 413
		...
		&& pMob[conn].MOB.Carry[slot].sIndex != 5813 && pMob[conn].MOB.Carry[slot].sIndex != 5817
		&& pMob[conn].MOB.Carry[slot].sIndex != 5811 && pMob[conn].MOB.Carry[slot].sIndex != 5812
		...
		&& (pMob[conn].MOB.Carry[slot].sIndex < 5972 || pMob[conn].MOB.Carry[slot].sIndex > 6500)
		&& (pMob[conn].MOB.Carry[slot].sIndex < 5624 || pMob[conn].MOB.Carry[slot].sIndex > 5627)
		&& (pMob[conn].MOB.Carry[slot].sIndex < 2441 || pMob[conn].MOB.Carry[slot].sIndex > 2444)
		&& (pMob[conn].MOB.Carry[slot].sIndex < 5752 || pMob[conn].MOB.Carry[slot].sIndex > 6001)
