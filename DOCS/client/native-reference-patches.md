...
> suportado. Toda alteração ativa deve ser adaptada em `tmproject/` ou nos
> assets, compilada como `tmproject/client748/project.exe` e validada sem patch binário.
