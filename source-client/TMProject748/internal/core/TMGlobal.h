...
// WYD.exe 7.48 FUN_004431e4 indexes DAT_005b77c0 for affect types 0..39.
// Keep these first forty atlas entries byte-identical to the native table: the
// imported 7.59 values select wrong or absent cells in classic texture set 200.
