...
func TestOdinRandomSevenRunesCanYieldEverySecretStone(t *testing.T) {
	...
	for offset := 0; offset < 4; offset++ {
		// Intn(100)=4 representa o roll percentual 5/5; o segundo valor
		// escolhe deterministicamente uma das quatro Secret Stones.
		rng := &odinSecretStoneSequenceRNG{values: []int{4, offset}}
...
func TestOdinRandomSecretStonePersistenceFailureRestoresRunesAndGold(t *testing.T) {
	runes := [7]uint16{5110, 5111, 5112, 5113, 5114, 5115, 5116}
	// Intn(100)=4 representa o roll percentual 5/5.
	rng := &odinSecretStoneSequenceRNG{values: []int{4, 3}}
